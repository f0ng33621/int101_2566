...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
       System.out.println(calculateBMI(1.80,60));
       System.out.println(average(1,5,6));
       System.out.println("-------------------");
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
       ...
       System.out.println("Person A ID = "+A.getId());
       System.out.println(A.toString());
       Person B = A;
       Person C = new Person(3);
       B.setId(2);
       System.out.println("Person B ID = "+B.getId());
       System.out.println("Person C ID = "+C.getId());
